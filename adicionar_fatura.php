                    ...
                    <h1>Faturas</h1>
                            ...
                            <form  method="post">
                                ...
                                <div class="forms-goup">
                                    ...
                                    <input type="number" name="mensalidade" step="0.01" class="form-control" required >
                                </div>

                                <!-- Prestacoes -->
                                <div class="forms-goup">
                                    <label for="prestacoes">Prestaçoes</label>
                                    <input type="number" name="prestacoes" class="form-control" required
                                    placeholder="Em quantas vezes a compra foi dividida?">
                                </div>
                                <br>
